        ...
        <>
            <section className="w-full  ">
                <div className="relative w-full overflow-hidden ">
                    <div className="absolute inset-0 bg-gradient-to-r from-orange-300 via-violet-200 to-teal-300 opacity-80 pointer-events-none"></div>
                    {/* Grid overlay */}
                    <div className="absolute inset-0 bg-grid-pattern pointer-events-none"></div>

                    {/* Content */}
                    <div className="relative z-10  py-18 px-20 ">

                        <div className="mx-auto w-2/3 mb-14 text-center">
                        ...
                        <div className="ml-50 w-6xl  p-2">
                            <div className="absolute w-60 right-174 top-114 px-6 py-3 rounded-xl bg-amber-400 ">
                                <h2 className="text-black text-lg font-bold mb-4 text-center">
                                    Get Your Free consultation Today
                                </h2>
                                <button className="bg-black  text-white px-2 py-2 ml-12 mb-4  rounded-lg font-semibold hover:bg-gray-900 transition">
                            ...
                            <div className="flex gap-1 mx-auto">
                                <div className="flex">
                                    <div className="w-[180px] sm:w-[140px] md:w-[180px] lg:w-[240px] aspect-[9/16] overflow-hidden rounded-bl-2xl rounded-br-2xl rounded-tl-2xl  shadow-lg">
                                        <video
                                            src="/videos/Digital_M.mp4"   // path to your reel video
                                            autoPlay
                                            loop
                                            muted
                                            playsInline
